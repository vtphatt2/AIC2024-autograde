...
model_part2 = YOLO('best_sbd_mdt.pt')
...
def submit_part2(testset_image_files):
    with open('./submission/results_sbd_mdt.txt', 'w') as f:
        for image_file in testset_image_files:
            ...
            if len(results_part2[0].boxes) == 0:
                ...
                continue
            res_part2 = process_and_write_to_file(results_part2[0], rotated_image, width, height)
